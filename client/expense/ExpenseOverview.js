  ...
  const indicateExpense = (values) => {
    ...
    return (
        <Card className={classes.card}>
            ...
            <Card style={{ padding: '2.5em'}} >
                <Typography component="p" variant="h3" color='primary'  >
                ${expensePreview.month ? expensePreview.month.totalSpent : '0'} <span style={{display: 'block', fontSize:'.5em', marginTop: '1em'}}>so far this month</span>
                </Typography>
              </Card>
